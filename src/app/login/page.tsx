    ...
    <div className="min-h-screen bg-[#03012a] text-gray-300 flex flex-col justify-center items-center px-4">
      ...
      >
        ...
        <div className="bg-[#050233] p-8 rounded-lg shadow-lg">
          <h2 className="text-2xl font-bold text-purple-300 mb-6 text-center">Log In</h2>
          ...
          <div className="mt-4 text-center">
            <Link href="/forgot-password" className="text-sm text-purple-400 hover:text-purple-300 transition duration-300">
